...
$EXEC_CMD "forge create --rpc-url http://\${STACK_SVC_FXETH_GETH_1}:8545 --private-key 888814df89c4358d7ddb3fa4b0213e7331239a80e1f013eaa7b2deca2a41a218 /app/contracts/AddressList.sol:AddressList --json > /tmp/deploy.json.$$ && cp -f /tmp/deploy.json.$$ /data/AddressList.deploy.json"
